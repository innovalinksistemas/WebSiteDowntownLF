...
export const ui = {
  es: {
    ...
    "testimonials.t1.quote": "Excelente servicio. El aire acondicionado funciona de maravilla, la habitación estaba preparada preciosa, Frank fue increíble, y el bar y el restaurante son muy convenientes.",
    "testimonials.t2.quote": "¡Excelente ubicación! El personal fue absolutamente increíble: amabilísimos, serviciales y de verdad te cuidan.",
    "testimonials.t3.quote": "¡Simplemente una de las mejores estadías! El hotel es hermoso y muy acogedor. Su personal es excelente, un servicio de calidad. ¡Los felicito! Definitivamente volveré.",
    "testimonials.t4.quote": "¡Nos encantó este lugar! Todo limpísimo, un equipo de limpieza y recepción excelente, el restaurante increíble, todos los días todos se alegraban de vernos. Nos ayudaron con los tours y la ubicación es perfecta.",
    // ── Gallery
  ...
  en: {
    ...
    "testimonials.t1.quote": "Great service. The AC works amazing, the room preparation was beautiful, Frank was awesome, and the bar and restaurant are very convenient.",
    "testimonials.t2.quote": "Great location! The staff was absolutely amazing: so kind, helpful, and they really take care of you.",
    "testimonials.t3.quote": "Simply one of the best stays! The hotel is beautiful and very cozy. The staff is excellent, quality service. Congratulations! I will definitely be back.",
    "testimonials.t4.quote": "Loved this place! So clean, great housekeeping and front-of-house staff, the restaurant was amazing, everyone every day was so happy to see us and so friendly. They helped with tours and the location was great.",
    // ── Gallery
    "gallery.page.kicker": "Downtown La Fortuna Boutique Hotel",
