...
export const ui = {
  es: {
    ...
    "meta.privacy.title": "Política de Privacidad | Downtown La Fortuna Boutique Hotel",
    "meta.privacy.description": "Cómo Downtown La Fortuna Boutique Hotel recoge, usa y protege tus datos personales cuando visitas la web o reservas una estadía.",
    ...
    "offers.green.desc": "Hospedaje con desayuno diario, entrada a Puentes Colgantes, Catarata La Fortuna y Parque Ecológico, aguas termales Paradise Hot Springs o Pura Vida con cena incluida, y vehículo 4x2 para moverte a tu ritmo. Aplican restricciones. Reservación previa obligatoria.",
    ...
    "testimonials.t1.quote": "great service, AC works amazing, room preparation was beautiful, frank was awesome, and the bar and restaurant are very convenient.",
    "testimonials.t2.quote": "Great location! The staff was absolutely amazing!! So so kind, helpful, and really takes care of you.",
    ...
    "testimonials.t4.quote": "Loved this place!!!! So clean, great housekeeping and front of house staff, restaurant was amazing, everyone everyday was so happy to see us and so friendly, they helped with tours and the location was great!!!",
    // ── Gallery
  ...
  en: {
    ...
    "meta.privacy.title": "Privacy Policy | Downtown La Fortuna Boutique Hotel",
    "meta.privacy.description": "How Downtown La Fortuna Boutique Hotel collects, uses and protects your personal data when you visit the website or book a stay.",
    ...
    "offers.green.desc": "Stay with daily breakfast, entry to the Hanging Bridges, La Fortuna Waterfall and the Ecological Park, Paradise Hot Springs or Pura Vida hot springs with dinner included, and a 4x2 car to explore at your own pace. Restrictions apply. Advance reservation required.",
