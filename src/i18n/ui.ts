...
export const ui = {
  es: {
    ...
    "offers.green.priceUnit": "por persona y noche",
    "offers.green.tiers": "Ocupación doble, impuestos incluidos. Paquete de 3 noches; con 4 noches $90 y con 5 noches $85 por persona y noche.",
    ...
    "offers.green.fine": "*El hotel gestiona el vehículo 4x2; los detalles se confirman al reservar, sujeto a disponibilidad. Disponible únicamente en septiembre y octubre de 2026.",
  ...
  en: {
    ...
    "offers.green.price": "$95",
    "offers.green.priceUnit": "per person, per night",
    "offers.green.tiers": "Double occupancy, taxes included. 3-night package; 4 nights $90 and 5 nights $85 per person, per night.",
    ...
    "offers.green.fine": "*The hotel arranges the 4x2 vehicle; details are confirmed when booking, subject to availability. Available in September and October 2026 only.",
