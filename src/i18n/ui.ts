...
export const ui = {
  es: {
    ...
    "amenities.location.desc": "En el corazón de La Fortuna, cerca de todo lo que quiere descubrir.",
    "amenities.pool.title": "Piscina Tropical",
    "amenities.pool.desc": "Un espacio al aire libre para refrescarse y relajarse.",
    "amenities.dining.title": "Bar & Restaurante",
    "amenities.dining.desc": "Gastronomía y coctelería para disfrutar sin salir del hotel.",
    "amenities.breakfast.title": "Desayuno Incluido",
    "amenities.breakfast.desc": "Comience el día disfrutando sabores frescos y locales.",
    "amenities.parking.title": "Parqueo Privado",
    "amenities.parking.desc": "Seguro, gratuito y con carga para vehículos eléctricos.",
    "amenities.wifi.title": "WiFi de Alta Velocidad",
    "amenities.wifi.desc": "Conexión rápida y estable en todas las áreas del hotel.",
    ...
    "amenities.frontdesk.desc": "Atención y asistencia cuando lo necesite durante su estadía.",
    // ── Restaurants
  ...
  en: {
    ...
    "amenities.location.desc": "In the heart of La Fortuna, close to everything you came to discover.",
    "amenities.pool.title": "Tropical Pool",
    "amenities.pool.desc": "An outdoor space to cool off and unwind.",
    "amenities.dining.title": "Bar & Restaurant",
    "amenities.dining.desc": "Dining and cocktails to enjoy without leaving the hotel.",
    "amenities.breakfast.title": "Breakfast Included",
    "amenities.breakfast.desc": "Start your day with fresh, local flavors.",
    "amenities.parking.title": "Private Parking",
    "amenities.parking.desc": "Secure, complimentary, and with EV charging.",
    ...
    "amenities.frontdesk.desc": "Assistance whenever you need it during your stay.",
    // ── Restaurants
